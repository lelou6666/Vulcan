...
@media all and (max-width:1075px) 
	...
	.download-segment, .download-model {
	  width: 178px !important;
	}
		
		.download-series, .download-document {
	...
	#download-spec, #download-split1, #download-split2 {
...
<!-- This contains the hidden content for videos -->
      ...
      <div class="swiper-container swiper-parent">
        <div class="swiper-wrapper offset_wrapper">
          ...
          <div class="swiper-slide small-swiper" style="width:455px;"><a href="/products/griddles-charbroilers/" onClick="ga('send', 'event', 'Homepage Slider', 'Griddles and Charbroilers');"><img src="/images/homepage/griddles_slide.jpg" alt="Griddles &amp; Charbroilers" border="0" /></a> </div>
          ...
          <div class="swiper-slide large-swiper" style="width:910px;">
                ...
                <div id="slideshowWrapper">
                    <ul id="slideshow">
                        ...
                        <li><a href="/video-library/?video=79821473&title=Voltaggio%20Loves%20Vulcan&player=8" onClick="ga('send', 'event', 'Homepage Slider', 'Voltaggio Loves Vulcan');"><img src="/images/homepage/voltaggio_slide.jpg" border="0" id="Slider2" alt="Voltaggio Loves Vulcan" /></a></li>
                        <li><a href="/Products/Vulcan-Custom-Chain-Griddle/" onClick="ga('send', 'event', 'Homepage Slider', 'Vulcan Custom Chain Griddle');"><img src="/images/homepage/griddle_slide.jpg" border="0" id="Slider2" alt="Vulcan Custom Chain Griddle" /></a></li>
                        <li><a href="/Products/Electric-Low-Water-Energy-Convection-Steamer/" onClick="ga('send', 'event', 'Homepage Slider', 'Low Water Energy Steamer');"><img src="/images/homepage/steam_slide.jpg" border="0" id="" alt="Low Water Energy Steamer" /></a></li>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
	...
	<div id="video1" style='display:none; max-width:1055px; margin: 0 auto;'>
		...
		<div class="video_padding" id='video1_content'>
		    <div class="video_heading1">PowerFry5&trade; Performance and Efficiency
	...
	<div id="video3" style='display:none; max-width:1055px; margin: 0 auto;'>
	    <br /><br />
		<div class="video_padding">
		    <div class="video_heading1">Flip Burgers, Fill Orders and Make Money Faster with the VCCG Griddle
	...
	<div class="row" id="homepage_center">
    	<div class="sixty">
        	<table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                	<td valign="top" class="video_heading1">PowerFry5&trade; Performance and Efficiency</td>
                    <td>&nbsp;</td>
                    <td  valign="top" class="video_heading1">K Series Kettles Make Perfect Soup Stock</td>
                </tr>
                <tr>
                	<td  valign="top" class="video_heading2">See how the ENERGY STAR® qualified PowerFry5&trade; fryer redefines the traditional fryer for maximum efficiency. </td>
                    <td class="video_heading2">&nbsp;</td>
                    <td  valign="top" class="video_heading2">Our fast-cooking kettles feature an ellipsoidal design kettle bottom for superior heat transfer to make the perfect soup stock.</td>
                </tr>
                <tr>
                	<td colspan="3" height="30">&nbsp;</td>
                </tr>
                ...
                <tr>
                	<td  valign="top" class="video_heading1">Flip Burgers, Fill Orders and Make Money Faster with the VCCG Griddle.</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                	<td  valign="top" class="video_heading2">Energy efficient with quick recovery times and even temperatures, the Vulcan Custom Chain Griddle (VCCG) is completely customizable to meet your specific operational needs.</td>
                    <td class="video_heading2">&nbsp;</td>
                    <td  valign="top" class="video_heading2">See how Vulcan's Combi Oven provides ultimate kitchen convenience with its three easy-to-use knobs. The humidity level automatically adjusts after you set the temperature and time, ensuring simple operation and consistent results.</td>
        	...
        	<table cellpadding="0" cellspacing="0">
                <tr>
                	...
                	<td>
                        ...
                        <div class="separator"></div>
                        <div class="feature_break"><div style="margin-right:8px;"><img src="/images/homepage/v_heart.png" alt="Vulcan Sustainability" style="padding-top:10px; width:100%; max-width:95px; max-height:90px; height:90px; height:auto;"/></div></div>
                	    <div class="feature_break2">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                ...
                                <tr>
                                    <td style="color:#c3c2c2; font-size:16px; font-family:'helvetica', Arial, sans-serif;">ITW has been recognized by ENERGY STAR® as Partner of the Year for two years and Partner of the Year – Sustained Excellence for four years.</td>
                                </tr>
                                <tr>
                	    ...
                	    <div class="feature_break2">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="color:#c3c2c2; font-size:16px; font-family:'helvetica', Arial, sans-serif;">Each award highlights our mission to produce equipment with the foodservice industry's needs in mind.</td>
                                </tr>
                                <tr>
