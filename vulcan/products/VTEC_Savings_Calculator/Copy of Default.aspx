...
<TITLE>VTEC Savings Calculator 10-26-2011-conversion test.xlsx</TITLE>
...
*.ee122 {
	...
	PADDING-RIGHT: 1px;
	BORDER-TOP: windowtext 0.75pt solid;
	PADDING-LEFT: 0px;
	FONT-WEIGHT: 700;
	FONT-SIZE: 12pt;
	BACKGROUND: white;
...
*.ee137 {
	...
	FONT-SIZE: 12pt;
	VERTICAL-ALIGN: middle;
	BORDER-LEFT: windowtext 0pt solid;
	COLOR: blue;
	PADDING-TOP: 0px;
	BORDER-BOTTOM: windowtext 0.75pt solid;
	FONT-STYLE: normal;
...
*.ee1501 {
	BORDER-RIGHT: windowtext 0pt solid;
	PADDING-RIGHT: 1px;
	PADDING-LEFT: 0px;
	FONT-WEIGHT: 700;
	FONT-SIZE: 12pt;
...
<INPUT id=xl_spreadsheet type=hidden value="VTEC Savings Calculator 10-26-2011-conversion test.xlsx" name=xl_spreadsheet> <INPUT id=xl_client type=hidden value=h5.2.29 name=xl_client> <INPUT id=currentpanel type=hidden><INPUT id=panelidz type=hidden>
</span><font size="2"> 
...
<div style="background-image:url(/Vulcan/Products/VTEC_Savings_Calculator/bg_shadow.jpg); width:777px; " >

  <TABLE style="BORDER-COLLAPSE: collapse" cellPadding=3 width=683 align="center" bgcolor="#FFFFFF">
    <COLGROUP>
    <COL width=234>
    <COL width=210>
    <COL width=279>
    <TBODY>
      <TR style="HEIGHT: 50pt">
        <TD class=ee100 colid="1" rowid="1" sheetid="1" width="219" style="text-align: center; vertical-align: middle; background-color:#333333"><font face="Arial" size="2"> <IMG 
      height=59 alt="Vulcan logo.png" 
      src="Vulcan-logo-silo-4c.png" 
      width=200></font></TD>
        <TD class=ee103 colSpan=2 colid="2" rowid="1" sheetid="1" style="background-color: #333333"><img  align="left"src="/Vulcan/Products/VTEC_Savings_Calculator/title.gif" width="306" height="48"> <A href="javascript:print();"><img border="0" align="right" src="/Vulcan/Products/VTEC_Savings_Calculator/printer.gif" width="40" height="48"></A></TD>
      </TR>
      <TR >
        <TD colspan="3" ><img src="/Vulcan/Products/VTEC_Savings_Calculator/spacer.gif" width="1" height="1"></TD>
      </TR>
      <TR style="HEIGHT: 25pt">
        <TD class=ee109 colid="1" rowid="2" sheetid="1" width="219" height="23">&nbsp;</TD>
        <TD class=ee112 colid="2" rowid="2" sheetid="1" width="244" height="23">
		<font face="Arial" size="2">Select 
          competitive charbroiler/unit size </font></TD>
        <TD class=ee115 colid="3" rowid="2" sheetid="1" width="212" height="22">&nbsp;</TD>
      </TR>
      <TR style="HEIGHT: 25pt">
        <TD class=ee128 colid="1" rowid="3" sheetid="1" width="218">
		<span style="font-weight: 400">
		<font face="Arial" color="#800000" style="font-size: 12px">Manufacturer: 
		Model Family </font> 
		</span> 
		<FONT class=ee121 face="Arial" size="2" color="#800000" style="font-size: 12px"><SUP>
		<span style="font-weight: 400">1</span></SUP></FONT></TD>
        <TD class=ee122 colid="2" rowid="3" sheetid="1" width="244"><FIELDSET id=XLEW_1_3_2ssc 
      style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; BORDER-LEFT: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px">
            <font face="Arial"><span style="font-size: 11pt"><font size="2">
            <SELECT 
      class=ee150 id=XLEW_1_3_2 style="WIDTH: 100%" tabIndex=2 
      onchange="recalc_onclick('XLEW_1_3_2')" size=1 name=XLEW_1_3_2>
        ...
        value="Wolf: SCBxxC">Wolf: SCBxxC</OPTION>
            </SELECT></font></span></font></FIELDSET></TD>
        <TD class=ee125 colid="3" rowid="3" sheetid="1" width="213"><font face="Arial"> <span style="font-size: 11pt"><font size="2">
          <INPUT class=ee127 
      id=XLEW_1_3_3 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" value="Vulcan VTEC" 
      tabIndex=-1 readOnly name=XLEW_1_3_3>
          </font></span></font></TD>
      </TR>
      <TR style="HEIGHT: 21pt">
        <TD class=ee128 colid="1" rowid="4" sheetid="1" width="217">
		<font face="Arial" style="font-size: 12px"><font color="#800000">{Select} Approx. Unit Width (in)</font> </font></TD>
        <TD class=ee131 colid="2" rowid="4" sheetid="1" width="244"><FIELDSET id=XLEW_1_4_2ssc 
      style="BORDER-RIGHT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; BORDER-LEFT: 0px; PADDING-TOP: 0px; BORDER-BOTTOM: 0px">
            <font face="Arial"><span style="font-size: 11pt"><font size="2">
            <SELECT 
      class=ee150 id=XLEW_1_4_2 style="WIDTH: 100%" tabIndex=3 
      onchange="recalc_onclick('XLEW_1_4_2')" size=1 name=XLEW_1_4_2>
        ...
        value=60>60</OPTION>
            ...
            </font></span><font size="2"> </font> </font>
          </FIELDSET>
          </font></TD>
        <TD class=ee134 vAlign=top align=left colid="3" rowid="4" 
      sheetid="1" width="208"><font face="Arial" size="2"> 
		<SPAN 
      style="MARGIN-TOP: 1px; Z-INDEX: 2; MARGIN-LEFT: 24px; WIDTH: 101px; POSITION: absolute; HEIGHT: 57px"><img src="/Vulcan/Products/VTEC_Savings_Calculator/irx_logo.jpg" width="150" height="80"></SPAN>&nbsp; </font></TD>
      </TR>
      <TR style="HEIGHT: 16pt">
        <TD class=ee128 colid="1" rowid="5" sheetid="1" width="217">
		<font color="#800000" style="font-size: 12px" face="Arial">{Enter} Hours of Operation/day (hr)</font><font face="Arial" size="2"> </font></TD>
        <TD class=ee145 colid="2" rowid="5" sheetid="1" width="244"><font face="Arial"><span style="font-size: 11pt"><font size="2">
          <INPUT class=ee150 
      id=XLEW_1_5_2 onKeyDown="onEnterPress('XLEW_1_5_2');" 
      style="PADDING-RIGHT: 1px; WIDTH: 244; height:31" tabIndex=4 
      ...
      value=10 name=XLEW_1_5_2 downkey="XLEW_1_6_2">
        ...
        <TD class=ee139 colid="3" rowid="5" sheetid="1" width="212">&nbsp;</TD>
      </TR>
      <TR style="HEIGHT: 18pt">
        <TD class=ee128 colid="1" rowid="6" sheetid="1" width="217">
		<font face="Arial" color="#800000" style="font-size: 12px">{Enter} Cost per 1 therm ($/therm)</font><font face="Arial" size="2" color="#800000"> </font><font face="Arial" size="2">&nbsp;</font><FONT class=ee148 face="Arial" size="2"><SUP>2</SUP></FONT></TD>
        <TD colid="2" rowid="6" sheetid="1" width="244" class="ee145"><font face="Arial"><span style="font-size: 11pt"><font size="2">
          <INPUT class=ee150 
      id=XLEW_1_6_2 onKeyDown="onEnterPress('XLEW_1_6_2');" 
      style="PADDING-RIGHT: 1px; WIDTH: 243; height:32" tabIndex=5 
      ...
      value=1.00 name=XLEW_1_6_2 upkey="XLEW_1_5_2">
        ...
        <TD class=ee139 colid="3" rowid="6" sheetid="1" width="212">&nbsp;</TD>
      </TR>
      <TR style="HEIGHT: 17pt">
        <TD class=ee143 colid="1" rowid="7" sheetid="1" width="217">
		<font face="Arial" style="font-size: 12px">UNIT Energy Rating (BTU/hr) </font></TD>
        <TD class=ee145 colid="2" rowid="7" sheetid="1" width="244"><font face="Arial"><span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_7_2 
      ...
      tabIndex=-1 readOnly value=0 name=XLEW_1_7_2>
        ...
        <TD class=ee147 colid="3" rowid="7" sheetid="1" width="213"><font face="Arial"> <span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_7_3 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
      ...
      <TR style="HEIGHT: 17pt">
        <TD class=ee143 colid="1" rowid="8" sheetid="1" width="217">
		<font face="Arial" style="font-size: 12px">Operating Cost/day ($)</font><font face="Arial" size="2"> </font> <FONT class=ee148 face="Arial" size="2"><SUP>3</SUP></FONT></TD>
        <TD class=ee149 colid="2" rowid="8" sheetid="1" width="244"><font face="Arial"><span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_8_2 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
      tabIndex=-1 readOnly value=- name=XLEW_1_8_2>
          </font></span></font></TD>
        <TD class=ee147 colid="3" rowid="8" sheetid="1" width="213"><font face="Arial"> <span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_8_3 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
      ...
      <TR style="HEIGHT: 17pt">
        <TD class=ee143 colid="1" rowid="9" sheetid="1" width="217">
		<font face="Arial" style="font-size: 12px">Operating Cost/year ($)</font><font face="Arial" size="2"> </font> <FONT class=ee148 face="Arial" size="2"><SUP>4</SUP></FONT></TD>
        <TD class=ee149 colid="2" rowid="9" sheetid="1" width="244"><font face="Arial"><span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_9_2 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
      tabIndex=-1 readOnly value=- name=XLEW_1_9_2>
          </font></span></font></TD>
        <TD class=ee147 colid="3" rowid="9" sheetid="1" width="213"><font face="Arial"> <span style="font-size: 11pt"><font size="2">
          <INPUT class=ee146 
      id=XLEW_1_9_3 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
      ...
      <TR style="HEIGHT: 22pt">
        <TD class=ee151 colid="1" rowid="10" sheetid="1" width="217"><font face="Arial" size="2">Cost Savings/year ($) </font></TD>
        <TD class=ee154 colid="2" rowid="10" sheetid="1" width="243"><font face="Arial" size="2">- </font></TD>
        <TD class=ee156 colid="3" rowid="10" sheetid="1" width="213"><font face="Arial"> <span style="font-size: 11pt"><font size="2">
          <INPUT class=ee155 
      id=XLEW_1_10_3 
      style="BORDER-RIGHT: #000000 0px solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 0px solid; OVERFLOW: hidden; BORDER-LEFT: #000000 0px solid; WIDTH: 100%; BORDER-BOTTOM: #000000 0px solid" 
...
<SCRIPT language=javascript type=text/javascript>try{var myDialog,handleSubmit;myDialog=new YAHOO.widget.Dialog("myDialog",{width:"330px",fixedcenter:true,draggable:false,close:false});myDialog.cfg.queueProperty("postmethod","form");handleSubmit=function(){if(document.getElementById("showagain")!=null)document.getElementById("showagain").checked==true&&YAHOO.util.Cookie.set(GetPageName()+"_showdialogagain","no",{expires:CookieExpiryDate(new Date,3)});myDialog.hide()};function onButtonsReady(){var oOKButton;oOKButton=new YAHOO.widget.Button("ok-button");function onButtonClick(){if(document.getElementById("showagain")!=null)document.getElementById("showagain").checked==true&&YAHOO.util.Cookie.set(GetPageName()+"_showdialogagain","no",{expires:CookieExpiryDate(new Date,3)});myDialog.hide()}oOKButton.addListener("click",onButtonClick)}YAHOO.util.Event.onContentReady("buttons",onButtonsReady);myDialog.render();var cookievalue=YAHOO.util.Cookie.get(GetPageName()+"_showdialogagain");if(cookievalue==null||cookievalue!="no"){document.getElementById("showagain")!=null&&document.getElementById("showagain").focus();myDialog.show()}else myDialog.hide()}catch(err){}function changestylesheet(sheets){recalc_onclick("");if(sheets=="allsheet")document.getElementById("default").href="support/print_friendly.css";else document.getElementById("default").href="";window.print()}</SCRIPT>
  ...
  width=501>
      ...
      class=ee148 face="Arial" size="2"><SUP>1</SUP> : Unit size and models are 
      ...
      class=ee148 face="Arial" size="2"><SUP>2</SUP> : $1.00/therm based on 
      ...
      sheetid="1" width="203"><font face="Arial" size="2"><SPAN 
      ...
      class=ee148 face="Arial" size="2"><SUP>3</SUP> : </FONT> <FONT 
      class=ee167 face="Arial" size="2">therm</FONT></TD>
      ...
      <TR style="HEIGHT: 17pt">
        <TD class=ee157 colid="1" rowid="16" sheetid="1" width="201"><FONT 
      class=ee148 face="Arial" size="2"><SUP>4</SUP> : 360 Operating days per 
          year</FONT></TD>
