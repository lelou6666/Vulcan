      ...
      if (AppCongif.ready && AppCongif.dragging) {
        ...
        if (AppCongif.monitorStartTime < new Date().getTime() - AppCongif.monitorInt) {
          AppCongif.pointerDistance = AppCongif.pointerEndPosX - AppCongif.pointerStartPosX;
			  ...
			  AppCongif.endFrame = AppCongif.currentFrame + Math.ceil(AppCongif.pointerDistance * 0.35 / base.$el.width());
			  }else{
			  ...
			  AppCongif.endFrame = AppCongif.currentFrame + Math.floor(AppCongif.pointerDistance * 0.35 / base.$el.width());
			  }
