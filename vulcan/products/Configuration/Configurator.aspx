    ...
    <div style="width:100%; margin:0 auto; background-image:url('images/steps_bg.jpg'); background-repeat:repeat-x; height:285px;">
        <div class="row">
            <div class="row_padding">
                ...
                <br />
                <div id="counter">
                    <table cellpadding="0" cellspacing="0" id="numbers" width="780">
                        <tr>
                            ...
                            <td style="max-width:130px; text-align:left;"><asp:Image ID="Arrow6" runat="server" ImageUrl="Images/step6.png"  /></td>
                        </tr>
                        <tr>
                            ...
                            <td class="seletedOptions"><asp:CheckBox ID="cbSheet" runat="server" /></td>
                            <td class="seletedOptions" colspan="2"  style="text-align:left;"><asp:CheckBox ID="cbGriddle" runat="server" /></td>
                            <!--<td class="seletedOptions"><asp:CheckBox ID="cbSalamander" runat="server" /></td>-->
                        </tr>
                    </table>
                </div>
            </div>
    	...
    	<div class="row_padding" style="overflow:auto;">
        	<br />
                <asp:Panel ID="Panel1" runat="server">
                    ...
                    <div class="steps">
                    	<div class="twenty">&nbsp;</div>
                        <div class="options" style="height:1px; top:-50px;">&nbsp;</div>
                        <div class="twenty">
                ...
                <asp:Panel ID="Panel5" runat="server">
                    ...
                    <div class="steps">
                        ...
                        <div class="options" style="height:1px; top:-50px;">&nbsp;</div>
                        <div class="twenty">
                            <asp:ImageButton ID="Next5" runat="server" ImageUrl="Images/step6_right.png" onclick="Next5_Click" CssClass="right_step"  />
                        </div>
                    </div>
                </asp:Panel>
                <asp:Panel ID="Panel6" runat="server">
                    <div class="twenty">&nbsp;</div>
                    <div class="options">
                    	<div style="width:90%; margin:0 auto; border-bottom:1px solid #757575;"><p style="font-size:30px; line-height:32px; color:#fefefe; font-family:'futura medium condensed';"><br />SALAMANDER OPTIONS</p></div>
                        <br />
                        <div style="width:90%; margin:0 auto;">
                        	<asp:RadioButtonList runat="server" ID="cblSalamander" RepeatDirection="Vertical"></asp:RadioButtonList>
                            <div style="display:none;color:red;" id="Error5">Please select a salamander option.</div>
                            <asp:Label ID="lblSalamanderEmpty" runat="server"></asp:Label><br />
                        </div>
                    </div>
                    <div class="twenty">&nbsp;</div>
                    <br style="clear:both;" />
                    <div class="steps">
                        <div class="twenty">
                            <asp:ImageButton ID="Back6" runat="server" ImageUrl="Images/step5_left.png" onclick="Back6_Click" CssClass="left_step" />
                        </div>
                        <div class="options" style="height:1px; top:-50px;">&nbsp;</div>
                        <div class="twenty">
                            <asp:ImageButton ID="Finish" runat="server" ImageUrl="Images/finish.png" onclick="Finish_Click" CssClass="right_step"  />
                        </div>
                    </div>
                </asp:Panel>
                <br /><br />
...
<script type="text/javascript">
	if($(document).width() < 470) {
		...
		var step6 = document.getElementById("<%= Arrow6.ClientID %>");
		if($(step6).attr("src") == "Images/step6_on.png") {
			$("#numbers").css("left", "-520px");
		}
	}
	else if($(document).width() < 860) {
		var step4 = document.getElementById("<%= Arrow4.ClientID %>");
