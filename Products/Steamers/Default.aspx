...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/steamers/" />
    ...
    <style type="text/css">
		...
		.prod_listview li {
			background-image: url("/images/spec_arrow_green.png");
...
<div class="segment_fixed">
    <div style="background-image:url('/images/products/green_bar_wide.png'); background-position:bottom left; background-repeat:repeat-x; overflow: auto; position:relative;">
        <div class="row" style="overflow: hidden;">
            <div class="segment_bar">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td valign="bottom" class="segment_slant_td" style="height:58px; background-image:url('/images/products/green_bar_left.png'); 
                        ...
                        <td style="width:100%; background-color:#379f2a;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/steamers_icon.png" alt="Steamers" style="width:100%; max-width:36px; max-height:42px;" /></td>
                                    <td>&nbsp;<h1>Commercial Restaurant Steamers</h1></td>
                                </tr>
                            </table>
                        </td>
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/steamers_hero.png" alt="Steamers" style="width:100%; max-width:530px; vertical-align:bottom;" /></div>
                <div class="twocolumn">
                    <div class="row_padding" id="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="1582" /> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row_padding">
                 <div id="checkboxes">
                    ...
                    <div class="filter">
                         <div class="filter_title" id="filter_title2"><div class="filter_title_text">Water Connection</div><div class="expand"><img src="/images/plus.jpg" id="expand2" /></div></div>
                         <div id="checkbox2"><asp:CheckBoxList runat="server" ID="type" name="type" AutoPostBack="True"></asp:CheckBoxList></div>
                    </div>
                    <div class="filter">
                        <div class="filter_title" id="filter_title3"><div class="filter_title_text">Configuration</div><div class="expand"><img src="/images/plus.jpg" id="expand3" /></div></div>
                        <div id="checkbox3"><asp:CheckBoxList runat="server" ID="configuration" name="configuration" AutoPostBack="True"></asp:CheckBoxList></div>
                    </div>
                </div>
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        <h2 class="green_h2" style='border-bottom:1px solid #6c6c6a; margin-bottom:15px; text-transform:uppercase;'>People Have Also Viewed</h2>
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="13" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
    ...
    <script type="text/javascript" defer>
		...
		function TrackFiltering(filters) {
			ga('send', 'event', 'Steamers', filters);
		}
    </script>
</asp:Content>