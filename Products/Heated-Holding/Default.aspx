...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/heated-holding/" />
    ...
    <style type="text/css">
		...
		.prod_listview li {
			background-image: url("/images/spec_arrow_aqua.png");
...
<div class="segment_fixed">
    <div style="background-image:url('/images/products/aqua_bar_wide.png'); background-position:bottom left; background-repeat:repeat-x; overflow: auto; position:relative;">
        <div class="row" style="overflow: hidden;">
            <div class="segment_bar">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td valign="bottom" class="segment_slant_td" style="height:58px; background-image:url('/images/products/aqua_bar_left.png'); 
                        ...
                        <td style="width:100%; background-color:#01866d;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/holding_icon.png" alt="Heated Holding" style="width:100%; max-width:29px; max-height:53px;" /></td>
                                    <td>&nbsp;<h1>Heated Holding Cabinets – Restaurant &amp; Commercial</h1></td>
                                </tr>
                            </table>
                        </td>
                        <td valign="bottom" class="segment_slant_td"2 style="height:58px; background-image:url('/images/products/aqua_bar_right.png'); 
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/heated_holding_hero.png" alt="Heated Holding" style="width:100%; max-width:545px; vertical-align:bottom;" /></div>
                <div class="twocolumn">
                    <div class="row_padding" ID="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="1580" /> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="body_wrapper2">
        <div id="content">
            <div class="row_padding">
                 <div id="checkboxes">
                    ...
                    <div class="filter">
                         ...
                         <div id="checkbox2"><asp:CheckBoxList runat="server" ID="type" name="type" AutoPostBack="True"></asp:CheckBoxList></div>
                    </div>
                    <div class="filter">
                        <div class="filter_title" id="filter_title3"><div class="filter_title_text">Doors</div><div class="expand"><img src="/images/plus.jpg" id="expand3" /></div></div>
                        <div id="checkbox3"><asp:CheckBoxList runat="server" ID="doors" name="doors" AutoPostBack="True"></asp:CheckBoxList></div>
                    </div>
                </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="doors" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            <br style="clear:both;" />
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        <!--<h2 class="aqua_h2" style='border-bottom:1px solid #6c6c6a; margin-bottom:15px; text-transform:uppercase;'>People Have Also Viewed</h2>-->
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="16" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
            ...
            <br style="clear:both;" />
            <div class="banner">
				<a href="/products/ovens/?series=761"><img src="/images/cook_and_hold_callout.png" border="0"onClick="ga('send', 'event', 'Product Callout', 'Cook and Hold');" /></a>
			</div>
			<br style="clear:both;" />
			<div class="banner">
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
    ...
    <script type="text/javascript" defer>
		...
		function TrackFiltering(filters) {
			ga('send', 'event', 'Heated Holding', filters);
		}
    </script>
</asp:Content>