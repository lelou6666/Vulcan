...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/braising-pans/" />
    <style type="text/css">
		h1
		{
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td style="width:100%; background-color:#379f2a;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/braising_pan_icon.png" alt="Braising Pans" style="width:100%; max-width:44px; max-height:42px;"  /></td>
                                    <td>&nbsp;<h1>Restaurant Braising Pans</h1></td>
                                </tr>
                            </table>
                        </td>
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/braising_pans_hero.png" alt="Braising Pans" style="width:100%; max-width:543px; vertical-align:bottom;" /></div>
                <div class="twocolumn">
                    <div class="row_padding" id="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="1583" /> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row_padding">
                <div id="checkboxes">
                    ...
                    <div class="filter">
                         <div class="filter_title" id="filter_title2"><div class="filter_title_text">Configuration</div><div class="expand"><img src="/images/plus.jpg" id="expand2" /></div></div>
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        ...
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="15" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
			...
			<div class="banner">
				<a href="/k-12/" onClick="ga('send', 'event', 'Product Callout', 'K12');"><img src="/images/products/banners/k12.png" border="0" /></a>
			</div>
			<br style="clear:both;" />
        </div>
    </div>
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
    ...
    <script type="text/javascript" defer>
		...
		function TrackFiltering(filters) {
			ga('send', 'event', 'Braising Pans', filters);
		}
    </script>
</asp:Content>