...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/ovens/" />
    ...
    <style type="text/css">
		...
		.prod_listview li {
			background-image: url("/images/spec_arrow_purple.png");
...
<div class="segment_fixed">
    <div style="background-image:url('/images/products/purple_bar_wide.png'); background-position:bottom left; background-repeat:repeat-x; overflow: auto; position:relative;">
        <div class="row" style="overflow: hidden;">
            <div class="segment_bar">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td valign="bottom" class="segment_slant_td" style="height:58px; background-image:url('/images/products/purple_bar_left.png'); 
                        ...
                        <td style="width:100%; background-color:#6a016a;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/oven_icon.png" alt="Ovens" style="width:100%; max-width:33px; max-height:42px;" /></td>
                                    <td>&nbsp;<h1>Ovens</h1></td>
                                </tr>
                            </table>
                        </td>
                        <td valign="bottom" class="segment_slant_td2" style="height:58px; background-image:url('/images/products/purple_bar_right.png'); 
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/ovens_hero.png" alt="Ovens" style="width:100%; max-width:544px; vertical-align:bottom;" />
                <img src="/images/products/convection_ovens_2012.png" alt="Best in Class" class="segment_bestinclass" />
                </div>
                <div class="twocolumn">
                    <div class="row_padding" id="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="1579" /> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="body_wrapper2">
        <div id="content">
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        <h2 class="purple_h2" style='border-bottom:1px solid #6c6c6a; margin-bottom:15px; text-transform:uppercase;'>People Have Also Viewed</h2>
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="11" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
