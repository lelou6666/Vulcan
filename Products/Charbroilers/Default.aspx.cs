...
public partial class _Default : System.Web.UI.Page
{
	...
	protected void showGrid(object sender, EventArgs e)
    {
		...
		Response.Redirect("/products/charbroilers/");
	}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		Session.Add("AllCharbroilerItems1", size.Items);
		Session.Add("CharbroilerFilters1", FilterList1);
    }
    ...
    public void LoadSeries()
    {
        ...
        treq.TaxonomyId = 947; //Charbroilers Series
    ...
    public void LoadFilter(int TaxonomyId, CheckBoxList cbList, int listNumber)
    {
        ...
        foreach (TaxonomyBaseData tbase in tbases)
        {
			if(!IsPostBack)
			{
				...
				if(listNumber == 1)
				{
					if(Session["AllCharbroilerItems1"] != null) {
						 foreach(ListItem item in (ListItemCollection)Session["AllCharbroilerItems1"])
						 {
