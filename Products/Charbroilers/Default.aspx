...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/charbroilers/" />
    <style type="text/css">
		h1
		{
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td style="width:100%; background-color:#ba371e;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/charbroiler_icon.png" alt="Charbroilers" style="width:100%; max-width:46px; max-height:44px;" /></td>
                                    <td>&nbsp;<h1>Commercial Charbroilers</h1></td>
                                </tr>
                            </table>
                        </td>
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/charbroilers_hero.png" alt="Charbroilers" style="width:100%; max-width:500px; vertical-align:bottom;" />
                ...
                <div class="twocolumn">
                    <div class="row_padding" ID="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="5835" /> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row_padding">
                <div id="checkboxes">
                    ...
                    <div class="filter">
                        <div class="filter_title" id="filter_title1"><div class="filter_title_text">Size (inches)</div><div class="expand"><img src="/images/plus.jpg" id="expand1" /></div></div>
                        <div id="checkbox1"><asp:CheckBoxList runat="server" ID="size" name="size" AutoPostBack="True" RepeatColumns="3"></asp:CheckBoxList></div>
                    </div>
                </div>
            </div>
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        <h2 class="orange_h2" style='border-bottom:1px solid #6c6c6a; margin-bottom:15px; text-transform:uppercase;'>People Have Also Viewed</h2>
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="20" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
			...
			<div class="banner">
				<a href="/irx/"><img src="/images/products/banners/irx.png" border="0" onClick="ga('send', 'event', 'Product Callout', 'IRX');" /></a>
			</div>
			<br style="clear:both;" />
        </div>
    </div>
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
    ...
    <script type="text/javascript" defer>
		...
		function TrackFiltering(filters) {
			ga('send', 'event', 'Griddles and Charbroilers', filters);
		}
    </script>
</asp:Content>