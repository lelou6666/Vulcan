...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/griddles-charbroilers/" />
    <style type="text/css">
		h1
		{
                        ...
                        <td style="width:100%; background-color:#ba371e;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td>&nbsp;<h1>Commercial Griddles &amp; Charbroilers</h1></td>
                                </tr>
                            </table>
                        </td>
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/griddles_charbroilers_hero.png" alt="Griddles Charbroilers" style="width:100%; max-width:500px; vertical-align:bottom;" />
                ...
                <div class="twocolumn">
                    <div class="row_padding" ID="segment_desc">
                        <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="1578" /> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="content">
            <div class="row_padding">
                <div id="checkboxes">
                    ...
                    <div class="filter">
                         <div class="filter_title" id="filter_title2"><div class="filter_title_text">Type</div><div class="expand"><img src="/images/plus.jpg" id="expand2" /></div></div>
            ...
            <div class="also_view_callouts">
                <div class="row">
                    <div class="row_padding">
                        ...
                        <CMS:Collection runat="server" ID="Collection1" DefaultCollectionID="12" DoInitFill="true" DisplayXslt="/xsl/also_view.xsl" GetHtml="true"  />
                    </div>
                </div>
            </div>
