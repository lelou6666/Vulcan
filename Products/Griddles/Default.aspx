...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/products/griddles/" />
    <style type="text/css">
		h1
		{
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td style="width:100%; background-color:#ba371e;">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="icon"><img src="/images/products/griddle_icon.png" alt="Griddles" style="width:100%; max-width:46px; max-height:44px;" /></td>
                                    <td>&nbsp;<h1>Commercial Griddles</h1></td>
                                </tr>
                            </table>
                        </td>
    ...
    <div id="right_fade_product1">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                <div class="twocolumn"><img src="/images/products/griddle-hero.png" alt="Griddles" style="width:100%; max-width:500px; vertical-align:bottom;" />
                </div>
                <div class="twocolumn">
        ...
        <div id="content">
            <div class="row_padding">
                <div id="checkboxes">
                    ...
                    <div class="filter">
                        <div class="filter_title" id="filter_title2"><div class="filter_title_text">Size (inches)</div><div class="expand"><img src="/images/plus.jpg" id="expand2" /></div></div>
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
    ...
    <script type="text/javascript" defer>
		...
		function TrackFiltering(filters) {
			ga('send', 'event', 'Griddles', filters);
		}
    </script>
</asp:Content>