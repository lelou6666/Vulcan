...
public partial class _Default : System.Web.UI.Page
{
	...
	protected void showGrid(object sender, EventArgs e)
    {
		...
		Response.Redirect("/products/griddles/");
	}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		Session.Add("AllGriddleItems2", size.Items);
		Session.Add("GriddleFilters1", FilterList1);
		Session.Add("GriddleFilters2", FilterList2);
    }
    ...
    public void LoadSeries()
    {
        ...
        treq.TaxonomyId = 348; //Griddles Series
