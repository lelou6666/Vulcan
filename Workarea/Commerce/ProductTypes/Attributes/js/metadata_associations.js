...
function ek_ma_LoadMetaChildPage(type, tagtype, metadataFormTagId, WAPath) 
{
	...
	if (ek_ma_IsBrowserIE()) 
	{
		...
		if (ek_ma_validateObject(frameObj)) 
		{
			...
			{
				// MetaTagType_Image:
				windObj = window.open(WAPath + 'mediamanager.aspx?actiontype=library&scope=images&autonav=' + folder + '&enhancedmetaselect=1&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 760 + ',height=' + 580 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
			}
			else if (ek_ma_isContentType(metadataFormTagId))
			{
				// MetaTagType_Content:
				windObj = window.open(WAPath + 'mediamanager.aspx?actiontype=library&scope=&type=quicklinks&autonav=' + folder + '&enhancedmetaselect=1&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 760 + ',height=' + 580 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
			}
			else if (ek_ma_isHyperLinkType(metadataFormTagId))
			{
				// MetaTagType_HyperLink:
				windObj = window.open(WAPath + 'mediamanager.aspx?actiontype=library&scope=hyperlink&type=hyperlinks&autonav=' + folder + '&enhancedmetaselect=1&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 760 + ',height=' + 580 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
			}
	...
	else 
	{
		...
		if (ek_ma_isListSummaryType(metadataFormTagId))
		{
			...
			windObj = window.open(WAPath + 'blankredirect.aspx?MetaSelectContainer.aspx?FolderID=' + id + '&browser=1&WantXmlInfo=1&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 600 + ',height=' + 400 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
		}
		else if (ek_ma_isImageType(metadataFormTagId))
		{
			// MetaTagType_Image:
		...
		{
		    windObj = window.open(WAPath + 'MetaSelectContainer.aspx?target_page=MetaSelect.aspx&type=' + type + '&tagtype=' + tagtype + '&id=' + id + '&title=' + title + '&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 760 + ',height=' + 580 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
		}
		else if (ek_ma_isUserType(metadataFormTagId))
		{
		    windObj = window.open(WAPath + 'MetaSelectContainer.aspx?target_page=MetaSelect.aspx&type=' + type + '&tagtype=' + tagtype + '&id=' + id + '&title=' + title + '&metadataFormTagId=' + metadataFormTagId + '&separator=' + delimeterChar + '&selectids=' + id + '&selecttitles=' + title,'Preview','width=' + 760 + ',height=' + 580 +',status=no,resizable=yes,scrollbars=no,location=no,toolbar=no');
		...
		if (id && id.length)
		{
			...
			if (ek_ma_isImageType(metadataFormTagId))
			{
				...
				if (id.length > idx)
				{
					...
					{
						thumbnail = thumbnail.substring(0, idx) + ".gif";
					}
					obj.src = thumbnail;
				}
			}
