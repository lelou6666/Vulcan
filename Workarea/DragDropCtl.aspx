                 ...
                 <div id="DMStabs">
	                    ...
	                    <div id="tabFileUpload">
		                   <div id="ek_DMSUploadUI" runat="server" >
                                    ...
                                    <asp:Button Text="Upload" CssClass="greenHoverDD buttonDD  buttonLeftDD buttonUpload" ID="uploadFile" runat="server" OnClientClick="return CheckFileExists();" OnClick="uploadFile_Click" /> 
                                    <asp:Button Text="Cancel" CssClass="redHoverDD buttonDD  buttonLeftDD buttonCancel" ID="btnCancel" runat="server"  OnClientClick="cancelDialog();" />                                                  
                                 </div>
	                    </div>
	                     <div runat="server" id="tabMultipleDMS">
	                        <div class="ui-helper-clearfix" style="margin-bottom: .5em">
                                <input type="button" class="greenHoverDD buttonDD  buttonLeftDD buttonUpload" value="Upload" onclick="MultipleDocumentUpload();" />
