...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/griddles-sem/thank-you/" />
...
<div class="segment_body">
    ...
    <div class="body_wrapper2">
        <div class="row" style="overflow:hidden;">
            <div class="row_padding">
                ...
                <CMS:ContentBlock ID="ContentBlock1" runat="server" DefaultContentID="5166" /> 
                <br />
    ...
    <div id="right_fade_product1">
         <div class="row range-sem-body">
         	<div class="sixty">
                <img src="/images/products/griddle-hero.png" alt="Griddles" style="width:100%; max-width:521px; vertical-align:bottom;" />
                <img src="/uploadedImages/Vulcan/Vulcan_Categories/BIC-Griddle-2014.png" alt="Best in Class" class="segment_bestinclass">
            </div>
            <div class="forty">
                <div class="row_padding">
                	<br />
                    <!--dev: DefaultContentID="2442" -->
                	<CMS:ContentBlock ID="TestimonialBlock" runat="server" DefaultContentID="5167" /> 
                </div>
            </div>
         </div>
         <br style="clear:both;" />
...
<asp:Content ID="page_script" ContentPlaceHolderID="pageScripts" Runat="Server">
 ...
 <script type="text/javascript">
  function fnOnUpdateValidators() {
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/964139843/?label=xF_lCMq-hVkQw7beywM&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
</asp:Content>