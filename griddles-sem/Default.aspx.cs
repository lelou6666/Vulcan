...
public partial class _Default : System.Web.UI.Page
{
	...
	protected void Submit_Click(object sender, EventArgs e)
    {
		if (Page.IsValid)
		{
			...
			SendToPowerObjects();
			Response.Redirect("/griddles-sem/thank-you/");
    ...
    public string CreateXml()
    {
		...
		sb.Append(string.Format("<product>{0}</product>", "Griddles"));
	...
	public void SaveToDB()
    {
		...
		try {
			...
			command.Parameters.Add("@product","Griddles");
	...
	public void EmailNotification()
    {
		...
		message = "<span style='font-family: Arial, Verdana; font-size:12px;'>"
 				+ "The following individual has submitted a request for a griddle quote.<br /><br />"
        ...
        mailclient.MailSubject = "Vulcan Griddle Quote Request";
	...
	public void SendToPowerObjects()
	{
		string postData = "powf_4a650f6298d8e41180f3fc15b4289e3c=" + first.Text
						...
						+ "&powf_2bffb11d99d8e41180f3fc15b4289e3c=Griddles" //product
						...
						+ "&powf_63e318f6d9ede41180f0c4346bac3fa4=Griddles SEM - Request A Quote" 
