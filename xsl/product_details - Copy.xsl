			...
			<table celllpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2" align="center">
						<table id="detail_thumbs">
							<tr>
								<td>
									<xsl:if test="string-length(/root/image1/node()) &gt; 0">
										<div class="product_thumb active_product_thumb" id="product_img1">
											<img id="product_image1" src="{/root/image1/node()}" style="width:100%; max-width:55px; max-height:55px; height:auto; vertical-align: middle; padding:5px;" border="0" alt="Product Image 2" />
										</div>
									</xsl:if>
								</td>
								<td>
									<xsl:if test="string-length(/root/image2/node()) &gt; 0">
										<div class="product_thumb" id="product_img2">
											<img id="product_image2" src="{/root/image2/node()}" style="width:100%; max-width:55px; max-height:55px; height:auto; vertical-align: middle; padding:5px;" border="0" alt="Product Image 3" />
										</div>
									</xsl:if>
								</td>
								<td>
