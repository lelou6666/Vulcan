...
public partial class _Default : System.Web.UI.Page
{
	...
	protected void Submit_Click(object sender, EventArgs e)
    {
		...
		{
			SendToPowerObjects();
			Response.Redirect("/combi-sem/thank-you/");
	...
	public void SaveToDB()
    {
		...
		try {
			...
			command.Parameters.Add("@product","Combi");
	...
	public void EmailNotification()
    {
		...
		string message = "";
		string EmailTo = "david.sager@itwfeg.com";
		//string EmailTo = "reneeh@marriner.com";
		
		message = "<span style='font-family: Arial, Verdana; font-size:12px;'>"
 				+ "The following individual has submitted a request for a combi quote.<br /><br />"
        ...
        mailclient.MailSubject = "Vulcan Combi Quote Request";
	...
	public void SendToPowerObjects()
	{
		string postData = "powf_4a650f6298d8e41180f3fc15b4289e3c=" + first.Text
						...
						+ "&powf_2bffb11d99d8e41180f3fc15b4289e3c=Combi" //product
						...
						+ "&powf_63e318f6d9ede41180f0c4346bac3fa4=Combi SEM - Request A Demo" 
