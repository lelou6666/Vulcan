...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/combi-sem/" />
            ...
            <div class="row_padding">
                ...
                <div class="headtwocolumn2">
                    <div class="row_padding" id="segment_desc" style="margin-top:15px;">
                        <div class="segment_title" style="padding-top:20px; padding-bottom:20px; text-align:center;">Request your free demo!</div>
                         <!--begin -->
                         <div id="free-quote">
                             <div class="row">
                                 <div class="twocolumn">
                            ...
                            <br style="clear:both;" />
                            <div class="row">
            					<div style="width:100%; text-align:center;"><asp:ImageButton ID="submit" runat="server" ImageUrl="/combi-sem/img/cta-button.jpg" ValidationGroup="ContactUs" OnClick="Submit_Click" Width="294" Height="47" /></div>
                            </div>
                            <br />
                         </div>
                         <!--end --> 
