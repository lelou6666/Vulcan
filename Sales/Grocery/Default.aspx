...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	<link rel="canonical" href="http://www.vulcanequipment.com/sales/grocery/" />
     ...
     <script type="text/javascript">
        ...
        function btnSearch_onclick() {
            ...
            if (txt.getValue().length > 0) {
				...
				window.location = '/sales/grocery/?search=' + escape(txt.getValue());
                return true;
    ...
    <div id="services_header">
         <div class="row">
            <div class="row_padding">
                <br />
               <h1 style="padding-bottom:15px;">Sales - Grocery</h1>
               <p>Use the option below to locate a sales professional to help you with your order.</p>
               ...
               <div style="background-image:url(/images/grey-shade.png); background-repeat:repeat; padding:25px 30px 30px 30px; max-width:600px; margin:0 auto;">
                   <h3 style="text-align:center;">I work in <font style="color:#e11b23;">grocery</font> 
                    ...
                    <tr>
                        <td id="contact_us">
                            <table border="0" align="center" width="300" style="margin:0 auto;">
                                <tr>
                                    <td align="center"><asp:TextBox ID="txtSearch" class="defaultText" title="Search by zip code" runat="server" Width="200" autocomplete="off"></asp:TextBox></td>
                                        ...
                                        <td valign="top">
                                           ...
                                           <% if (d.Email != "null") { %>
                                                    <% if (!string.IsNullOrEmpty(d.Email)) { %>
                                                        <p>Email: <a href="mailto:<%= d.Email%>" style="color:#000;"><%= d.Email%></a></p>
                                                    <% }
                                            } %>
                                           ...
                                           <% if (!string.IsNullOrEmpty(d.Website))
                                              {
                                                  ...
                                                  { %>
                                                    <p><a target="_blank" href="<%= d.Website %>" style="color:#000;"><%= d.Website.ToString().Replace("https://", "").Replace("http://", "").Replace("www.", "") %></a></p>
                                           <% } } %>
